...
- **Colors:**
  - Matte black / very dark background: `#121212`
  - Accent color (window frame 1px, titles, logo): green-turquoise `#389379` **or** orange `#FF6B00`
  - Normal text: white `#FFFFFF`
- **Buttons:** Flat, square buttons (no rounded corners), dark gray background `#333333`, white text.
...
## New project
Whenever I start a new project, ask me if I want to use Instructions for Claude, and which accent color to use: green-turquoise `#389379` or orange `#FF6B00`.
