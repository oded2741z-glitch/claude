...
אם לא שמתם שום קובץ אייקון, הבנייה מייצרת אייקון ברירת מחדל בעצמה (אריח כהה
עם `oT`) כדי שלא יישאר האייקון הכללי של PyInstaller.
...
* **אייקון החלון, לא רק של ה-EXE.** אם יש `app_icon.ico` (ראו "אייקון ל-EXE"
  ...
  הוא מצייר בקוד אריח כהה עם הסימן `oT` בכתום, כך שבכל מקרה לא נשארת הנוצה
  הכחולה של Tk.
