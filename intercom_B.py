#!/usr/bin/env python3
"""Headless P2P intercom - computer B (peer only).
...
by build_single_file.py; edit those and rebuild.
    ...
    python intercom_B.py --server-ip <computer A's address>

Control it by editing control_B.txt, which any other program may rewrite while
this is running; the live state is written back to status_B.txt.
"""
